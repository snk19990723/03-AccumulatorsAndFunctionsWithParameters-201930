...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 18
    answer = sum_of_digits(828)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    # Test 3:
    expected = 6
    answer = sum_of_digits(105)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    # Test 4:
    expected = 12
    answer = sum_of_digits(840)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def digits_in_cube(number):
    ...
    while True:
        if numbercub == 0:
            break
        digit_sum = digit_sum + (numbercub % 10)
        numbercub = numbercub // 10
...
def run_test_fancy_sums_of_digits():
    ...
    # Test 2:
    expected = 84328
    answer = fancy_sums_of_digits(32)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    # Test 3:
    expected = 91107
